...
This is what the limited dataset looks like:
...
Functions are chunks of code written to accomplish specific tasks. Suppose we wanted to evaluate the proportion of missing data in each column in `nhefs`. We could do this by writing a function:
```{r}
